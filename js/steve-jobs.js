...
function updateDepth(book, newPage) {
	...
	if (newPage<pages-3) 20="" $('.sj-book="" .p111="" .depth').css({="" width:="" depthwidth,="" right:="" -="" depthwidth="" });="" else="" .depth').css({width:="" 0});="" }="" function="" loadpage(page)="" {="" $.ajax({url:="" 'pages="" page'="" +="" page="" '.html'}).="" done(function(pagehtml)="" .p'="" page).html(pagehtml.replace('samples="" steve-jobs="" ',="" ''));="" addpage(page,="" book)="" var="" id,="" pages="book.turn('pages');" if="" (!book.turn('haspage',="" page))="" element="$('<div">',
			{'class': 'own-size',
